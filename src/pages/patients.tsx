            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="內科-李穎灝">內科-李穎灝</SelectItem>
                    <SelectItem value="內科-黃英哲">內科-黃英哲</SelectItem>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="col-span-3 flex items-center gap-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => setEditFormData({ ...editFormData, intubated: checked })}
                  />
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="col-span-3 flex items-center gap-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => setEditFormData({ ...editFormData, hasUnreadMessages: checked })}
                  />
