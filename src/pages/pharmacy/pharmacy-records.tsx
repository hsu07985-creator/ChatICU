...
export function PharmacyRecordsPage() {
  // ── 病患清單 ──
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1>藥事紀錄</h1>
        <p className="text-muted-foreground mt-1">藥師照護介入紀錄（四大類 27 細項）</p>
      </div>
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-4 md:grid-cols-4">
            ...
            <div className="space-y-1.5">
              <label className="text-sm font-medium">病患</label>
              {patientsLoading ? (
            ...
            {/* 類別 */}
            <div className="space-y-1.5">
              <label className="text-sm font-medium">建議類別</label>
              <Select
            ...
            {/* 細項 */}
            <div className="space-y-1.5">
              <label className="text-sm font-medium">細項</label>
              <Select
                value={selectedCode}
            ...
            {/* 醫師是否接受 */}
            <div className="space-y-1.5">
              <label className="text-sm font-medium">醫師是否接受</label>
            ...
            <ScrollArea className="h-[400px] pr-4">
              <div className="space-y-3">
                {records.map((record) => (
                  <div
                    key={record.id}
                    className="border-l-4 rounded-lg p-4 bg-white hover:shadow-md transition-shadow"
