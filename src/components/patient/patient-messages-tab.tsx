...
import { Activity, AlertCircle, CheckCircle2, ChevronRight, Clock, Filter, MessagesSquare, Pill, Reply, Shield, Stethoscope, ThumbsDown, ThumbsUp, Trash2, User, Users, Send, X, XCircle } from 'lucide-react';
