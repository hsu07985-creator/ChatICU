...
TASK_PROMPTS: dict[str, str] = {
    ...
    "pharmacist_polish": (
        ...
        "OUTPUT P:\n"
        "- Due to GI bleeding risk, please consider discontinuing "
        "Bokey (Aspirin, 100 mg/tab) 1 tab PO qd. "
        "Monitor: hemoglobin and hematocrit q6h.\n"
        "- Please consider adding Losec (Omeprazole, 40 mg/vial) 40 mg IV qd. "
        "Monitor: stool occult blood.\n"
        "- Please consider PRBC transfusion if Hb < 7.\n\n"
