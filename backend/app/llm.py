...
TASK_PROMPTS: dict[str, str] = {
    ...
    "pharmacist_polish": (
        ...
        "2. Do NOT remove any drug, dose, lab value, or monitoring item the pharmacist wrote.\n"
        ...
        "'<brief reason ≤20 words, 1 sentence>, please consider <adjusting / "
        "discontinuing / adding / switching to> <drug notation>.' "
        "Reason comes FIRST, then the polite request. Example: "
        ...
        "INPUT P: '1. sug D/C aspirin bcz GIB risk, f/u H&H q6h\\n"
        "2. add omeprazole 40mg PO qd, f/u stool OB\\n"
        "3. consider blood transfusion if Hb < 7'\n"
        "OUTPUT P:\n"
        "- Due to GI bleeding risk, please consider discontinuing Aspirin. "
        "Monitor: hemoglobin and hematocrit q6h.\n"
        "- Please consider adding Omeprazole 40 mg PO qd. Monitor: stool occult blood.\n"
        "- Please consider blood transfusion if Hb < 7.\n\n"
