...
robust to the column already existing or dialect-introspection differences
between dev/prod environments. The previous attempt at this migration used
``op.add_column`` + ``sa.inspect``, which silently failed on Railway and left
the schema at version 069.
"""
