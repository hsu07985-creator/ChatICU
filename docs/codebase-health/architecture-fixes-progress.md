...
- **D1 後續**:6 個凍結頁已拆 1(chat.tsx,2026-07-20 live 驗證發送流一致);已拆 4(chat、interactions、workstation、patients→抽 `PatientAddDialog` 930→676);剩 patient-detail(1576)、ai-chat(938)。(附帶發現:tsconfig 無 noUnusedLocals + eslint no-unused-vars off,兩者都不抓孤兒 import——前三頁殘留已清並補進 gate。)
- **C5**:staging 決策。
